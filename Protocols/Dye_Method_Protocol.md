...
***
<a name="Prep"></a> **Prepping for spectrophotometer analyses: addition of dye and collecting samples**
***
*In lab*
...
1.	You will begin by pouring the dye from the falcon tube into the body of water. 
	...
	2. It would also be a good idea to rinse the cap as well, as some of the dye can travel down the tube and leave little droplets of dye in the crevices of the cap. 
 
2.	Thoroughly mix the dye into the pool until it is evenly distributed and looks homogenous.
	1.	It is best if you take your time during this step, especially if it is a complex pool with large amounts of fauna. The more complex the pool, the harder it will be to efficiently mix in the dye. (Swim paddles on a pole works great :) )
...
3.	Now that the dye is mixed in, fill at least three falcon tubes from a minimum of three equidistant points in the pool.
	 ...
	 2.	The amount of water you put in each tube is entirely up to you, but there should be a minimum of 3mL. This is the preferred amount of solution to be added to the cuvettes when using the spectrophotometers. 
...
***
<a name="SOPforSmartSpec3000"></a> **Protocol for spectrophotometer: Smart Spec 3000**
***
...
4.	To begin, you must zero the machine with a blank reading.
  	1.	Add DI water to a clean cuvette.
  		2.	*Make sure you are using gloves while handling the instrument*
  		3.	*Only hold the cuvettes by the frosted sides, assuring that the clear sides are not touched.*
  		4.	*For the best results, use a pipette to insert 3mL of DI water.*
 	 ...
 	 1.	Insert the cuvette into the chamber.
    	2. *Make sure when inserting, that either clear sides are facing the light path. There will be an arrow indicating the direction in which the clear side of the cuvette should be facing.*
    3. Close the lid.
...
5.	Much like the previous step, you will be inserting a cuvette containing a substance into the cuvette chamber to find its absorbance. 
  	...
  	2. The number that appears on the screen will be the absorbency of the substance inside the cuvette.
...
***
<a name="SOPforGenesys5"></a> **Protocol for spectrophotometer: Genesys 5**
***
...
5.	You will set the wavelength by pressing the GO TO WL button.
  	1.	Type in the wavelength using the number keys and press ENTER when finished.
  		2.	For our purpose, you will be inputting 640nm.
6.	To begin, you must zero the machine with a blank reading.
  	1.	Add DI water to a clean cuvette.
  		2.	*Make sure you are using gloves while handling the instrument.*
  		3.	*Only hold the cuvettes by the frosted sides, assuring that the clear sides are not touched.*
  		4.	*For the best results, use a pipette to insert 3mL of DI water.*
  	5.	Wipe down the clear sides of the cuvette with Kimwipes, assuring that there are no smudges or dust, so that the spectrophotometer can get a clear reading.
  	6.	Insert the cuvette into the chamber.
  		7.	There are eight cell holders inside the compartment. Choose the first cell that should be labeled ‘B’ on the display screen. You can adjust the cell positions by pressing either CELL buttons. It will move according to the arrow located above/below the CELL.
  		8.	Make sure when inserting, that either clear side is facing the light path. The sensor will be on the left side of the compartment. 
  	9.	Close the lid of the compartment.
  	10.	Press the AUTO ZERO button to zero out the machine.
  	11.	You are now ready to begin reading different absorbances
...
7.	Much like the previous step, you will be inserting a cuvette (or several) containing a substance into the cuvette chamber, to find its absorbance. 
  	1.	Always wipe down the cuvette with Kimwipes to ensure the best reading.
  	2.	Each time you place a cuvette into the chamber, close the lid. The machine will automatically read the absorbance if it is in the cell facing the sensor. To read the absorbance in the next cell, simply press the CELL Arrow button to shift the cells.
  		3.	The number that appears on the screen will be the absorbency of the substance inside the cuvette.
...
***
<a name="Cleaningacuvette"></a> **Cleaning a cuvette**
***
